...
error_log("Initial session in user_login.php: " . print_r($_SESSION, true));

// Only redirect if both user_id and buyer_unique_id are set
if (isset($_SESSION['user_id']) && isset($_SESSION['buyer_unique_id'])) {
    error_log("Redirecting to dashboard due to existing session: " . print_r($_SESSION, true));
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        error_log("Login successful, updated session: " . print_r($_SESSION, true));
        header("Location: ../../buyer/user_dashboard.php");
        exit();
    } else {
...
// If redirected with an error, display it
if (isset($_GET['error'])) {
    $error = urldecode($_GET['error']);
    error_log("Redirected with error: $error");
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo get_translation('buyer_login'); ?></title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h1 class="card-title text-center mb-4"><?php echo get_translation('Buyer Login'); ?></h1>
                            ...
                            <p class="text-center mt-3"><a href="user_register.php"><?php echo get_translation('register_new_account'); ?></a></p>
